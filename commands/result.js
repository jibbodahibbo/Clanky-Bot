...
module.exports = {
	...
	async execute(message, args, client) {
		...
		let league_list = ["lulu", "paste","rp","5050","jorge","hrd","s7","vbfl","s8","s9","w3","smokey01",
			"smokey03","boss03","boss01","funnybones01","funnybones03","maddog01","maddog02","maddog03","dbsl","axeman01","axeman02","axeman03","dbsla","dbslp","stretch01","stretch02","stretch03"]; //must be lowercase
